...
<script>
   function check_input()
   {
      if (!document.member_form.id.value.trim()) { 
        // 회원가입 페이지에 사용자가 아이디를 입력하지 않았다면... trim()은 문자열 좌우에 공백을 제거하는 함수.
          	...
          	<form  name="member_form" method="post" action="member_insert.php">
			    <h2>회원가입</h2>
    		    	<div class="form id">
                  	...
                  	<img id="reset_button" style="cursor:pointer" src="./img/button_reset.png" onclick="reset_form()">
	           	</div>
           	</form>
        	</div> 
        </div> 
